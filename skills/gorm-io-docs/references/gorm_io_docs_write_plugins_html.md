Write Plugins | GORM - The fantastic ORM library for Golang, aims to be developer friendly.
Write Plugins
Callbacks
---------
...
[Improve this page](https://github.com/go-gorm/gorm.io/edit/master/pages/docs/write_plugins.md)
[Back to Top](#)
