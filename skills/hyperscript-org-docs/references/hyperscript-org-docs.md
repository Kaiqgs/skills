///\_hyperscript
[§](#_hyperscript-documentation) \_hyperscript documentation
...
* [Language Basics](#basics)
  ...
  + [Variables](#variables)
    ...
    - [Special Names & Symbols](#special-names-%26-symbols)
  ...
  + [Control Flow](#control-flow)
    - [Comparisons & Logical Operators](#comparisons-%26-logical-operators)
    - [Loops](#loops)
...
* [Debugging](#debugging)
  + [Beeping](#beeping)
  + [HDB - The Hyperscript Debugger](#hdb---the-hyperscript-debugger)
* [Extending](#extending)
* [Security](#security)
...
#### [§](#names_and_scoping) Variable Names & Scoping
...
#### [§](#scoping_modifiers) Scoping Modifiers
...
#### [§](#special-names-%26-symbols) Special Names & Symbols
...
Toggle Next Border
Toggle My Background
#### [§](#comparisons-%26-logical-operators) Comparisons & Logical Operators
...
#### [§](#aggregate_operations) Aggregate Operations
...
#### [§](#event_destructuring) Event Destructuring
...
Hello World
--
##### [§](#intersection) Intersection Events
...
#### [§](#function_namespacing) Namespacing
...
### [§](#finding-things) Finding Elements
...
`@attribute name`
:   An attribute literal starts with an `@` (hence, *at*tribute, get it?) and returns the value of that
    attribute.
`*style property`
:   A style literal starts with an `*` (a reference to [CSS Tricks](https://css-tricks.com/)) and returns the
...
#### [§](#in) Finding Things In Other Things
...
```
#### [§](#closest) Finding The Closest Matching (Parent) Element
...
```
#### [§](#positional) Finding Things By Position
...
```
#### [§](#relative_positional) Finding Things Relative To Other Things
...
### [§](#updating_things) Updating The DOM
...
#### [§](#show-hide) Showing & Hiding Things
...
##### [§](#settling) Class-Based Transitions
...
### [§](#async-keyword) The `async` keyword
