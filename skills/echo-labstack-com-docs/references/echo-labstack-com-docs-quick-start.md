...
Form application/x-www-form-urlencoded[​](#form-applicationx-www-form-urlencoded "Direct link to Form application/x-www-form-urlencoded")
-----------------------------------------------------------------------------------------------------------------------------------------
`POST` `/save`
| name | value |
| --- | --- |
...
```
Form multipart/form-data[​](#form-multipartform-data "Direct link to Form multipart/form-data")
-----------------------------------------------------------------------------------------------
`POST` `/save`
| name | value |
| --- | --- |
...
// => avatar.png
```
Handling Request[​](#handling-request "Direct link to Handling Request")
------------------------------------------------------------------------
...
```
Static Content[​](#static-content "Direct link to Static Content")
------------------------------------------------------------------
...
[Template Rendering](/docs/templates)[​](#template-rendering "Direct link to template-rendering")
-------------------------------------------------------------------------------------------------
