...
Routing
=======
Echo's router is based on [radix tree](https://en.wikipedia.org/wiki/Radix_tree), making
...
### Available HTTP Methods[​](#available-http-methods "Direct link to Available HTTP Methods")
...
### Method Parameters[​](#method-parameters "Direct link to Method Parameters")
...
### Handler Function Signature[​](#handler-function-signature "Direct link to Handler Function Signature")
...
```
Route Registration Methods[​](#route-registration-methods "Direct link to Route Registration Methods")
------------------------------------------------------------------------------------------------------
...
### Echo.Any()[​](#echoany "Direct link to Echo.Any()")
...
```
### Echo.Match()[​](#echomatch "Direct link to Echo.Match()")
...
### Form Parameters[​](#form-parameters "Direct link to Form Parameters")
...
```
Match-any / wildcard[​](#match-any--wildcard "Direct link to Match-any / wildcard")
-----------------------------------------------------------------------------------
...
Path Matching Order[​](#path-matching-order "Direct link to Path Matching Order")
---------------------------------------------------------------------------------
* Static
* Param
* Match any
...
### Basic Group Usage[​](#basic-group-usage "Direct link to Basic Group Usage")
```
...
```
### Group with Middleware[​](#group-with-middleware "Direct link to Group with Middleware")
```
...
```
### Advanced Group Examples[​](#advanced-group-examples "Direct link to Advanced Group Examples")
```
...
```
### Group Middleware Management[​](#group-middleware-management "Direct link to Group Middleware Management")
```
...
```
### Practical Example: RESTful API Structure[​](#practical-example-restful-api-structure "Direct link to Practical Example: RESTful API Structure")
```
...
```
### Group Benefits[​](#group-benefits "Direct link to Group Benefits")
...
Route Naming[​](#route-naming "Direct link to Route Naming")
------------------------------------------------------------
...
### Basic Route Naming[​](#basic-route-naming "Direct link to Basic Route Naming")
```
...
```
### Advanced Route Naming[​](#advanced-route-naming "Direct link to Advanced Route Naming")
```
// Multiple parameters  
...
```
URI Building[​](#uri-building "Direct link to URI Building")
------------------------------------------------------------
Echo provides two methods for generating URIs: `Echo.URI()` and `Echo.Reverse()`.
### Echo.URI() - Handler-based URI Generation[​](#echouri---handler-based-uri-generation "Direct link to Echo.URI() - Handler-based URI Generation")
...
```
### Echo.Reverse() - Name-based URI Generation[​](#echoreverse---name-based-uri-generation "Direct link to Echo.Reverse() - Name-based URI Generation")
...
```
### Benefits of Route Naming[​](#benefits-of-route-naming "Direct link to Benefits of Route Naming")
...
List Routes[​](#list-routes "Direct link to List Routes")
---------------------------------------------------------
...
### Example: Listing Routes[​](#example-listing-routes "Direct link to Example: Listing Routes")
```
// Handlers  
