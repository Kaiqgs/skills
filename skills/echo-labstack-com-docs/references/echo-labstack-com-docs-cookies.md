...
Cookie Attributes[​](#cookie-attributes "Direct link to Cookie Attributes")
---------------------------------------------------------------------------
| Attribute | Optional |
| --- | --- |
| `Name` | No |
...
Create a Cookie[​](#create-a-cookie "Direct link to Create a Cookie")
---------------------------------------------------------------------
```
...
Read a Cookie[​](#read-a-cookie "Direct link to Read a Cookie")
---------------------------------------------------------------
```
...
Read all the Cookies[​](#read-all-the-cookies "Direct link to Read all the Cookies")
------------------------------------------------------------------------------------
```
