...
1) Identify upstream target URL(s)[​](#1-identify-upstream-target-urls "Direct link to 1) Identify upstream target URL(s)")
---------------------------------------------------------------------------------------------------------------------------
```
...
```
2) Setup proxy middleware with upstream targets[​](#2-setup-proxy-middleware-with-upstream-targets "Direct link to 2) Setup proxy middleware with upstream targets")
--------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
```
3) Start upstream servers[​](#3-start-upstream-servers "Direct link to 3) Start upstream servers")
--------------------------------------------------------------------------------------------------
* `cd upstream`
* `go run server.go server1 :8081`
* `go run server.go server2 :8082`
4) Start the proxy server[​](#4-start-the-proxy-server "Direct link to 4) Start the proxy server")
--------------------------------------------------------------------------------------------------
```
go run server.go
```
